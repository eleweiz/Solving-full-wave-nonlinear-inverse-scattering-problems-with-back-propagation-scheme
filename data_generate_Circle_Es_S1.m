...
AA=[4,0.6,0,-0.2,Ep1;4,0.3,0,-0.2,1+1e-3;4,0.2,0.3,0.6,Ep1;4,0.2,-0.3,0.6,Ep1]; %% total number of circle, radius, xcenter, ycenter,epr;

epsil= annulus_gen_exa(MAX,Mx,AA);
epsil_exaS1=epsil;
% Pro_Para{1,nn}=Para;
