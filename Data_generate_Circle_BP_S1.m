...
epsil_bpS1 = reshape(x_int, Mx, Mx);
nn
end
...
[x_dom,y_dom] = meshgrid(tmp_domain, -tmp_domain);
figure
pcolor(x_dom,y_dom,epsil_bpS1); axis square; axis tight; shading flat;
title('BP Results');
colorbar
figure
pcolor(x_dom,y_dom,epsil_exaS1); axis square; axis tight; shading flat;
colorbar
title('Ground Truth Results');

clearvars -except epsil_bpS1 epsil_exaS1;
save('CNN_Data_Cir_S1_N20.mat')
